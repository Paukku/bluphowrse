...
def puolituntia(driver):
    # Kouluttaa vuorta
    klik = driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[2]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-main']/div/div/div[3]/a[@id='boutonBalade-montagne']")
    klik.click()
    sleep()
...
def alle2_puolitunti(driver):
    #koulutus 1h
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-main']/div/div/div[3]/a[@id='boutonBalade-montagne']").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr/td/div[@id='walkmontagneSlider']/ol/li[2]").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[1]/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr[2]/td/button").click()
    sleep()
...
def alle2_puolitoista(driver):
    ...
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-main']/div/div/div[3]/a[@id='boutonBalade-montagne']").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr/td/div[@id='walkmontagneSlider']/ol/li[4]").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[1]/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr[2]/td/button").click()
    sleep()
...
def alle2_viisi(driver):
    ...
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-main']/div/div/div[3]/a[@id='boutonBalade-montagne']").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[@id='walk']/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr/td/div[@id='walkmontagneSlider']/ol/li[11]").click()
    sleep()
    driver.find_element_by_xpath("/html/body/div[@id='container']/main[@id='content']/section/section/div[@id='console']/div[@id='sortable']/div[@id='col-right']/div[1]/div[1]/div[1]/div[1]/div[@id='walk-body-content']/div[@id='walk-wrapper']/div[@id='walk-tab-balade-montagne']/table/tbody/tr[2]/td/form/div[@id='walk-montagne-form']/div[@id='walk-montagne-form']/table/tbody/tr[2]/td/button").click()
    sleep()
